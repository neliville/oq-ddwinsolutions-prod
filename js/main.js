...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const newsletterForms = document.querySelectorAll(
    'form[id*="newsletter"], form:has(input[type="email"][placeholder*="email"])',
  )
      ...
      if (email) {
        ...
        try {
          ...
          const response = await fetch(
            "https://prod-XX.westeurope.logic.azure.com:443/workflows/NEWSLETTER_WORKFLOW/triggers/manual/paths/invoke?api-version=2016-10-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=SIGNATURE",
            {
              method: "POST",
              headers: {
