  ...
  if (window.appInsights && window.appInsights.trackEvent) {
    window.appInsights.trackEvent({
      ...
      properties: {
        ...
        ts: new Date().toISOString() // horodatage
      }
    });
  }
}
...
function generateUniqueId() {
  return "DDW-" + Date.now().toString(36).toUpperCase() + "-" + Math.random().toString(36).substr(2, 5).toUpperCase()
}
