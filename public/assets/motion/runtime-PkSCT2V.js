...
async function runScrollRefresh() {
    const { ScrollTrigger } = await getGsapRuntime();
 ...
 * @returns {Promise<{ revert: () => void }>}
 */
export async function createPageContext(scope, factory) {
