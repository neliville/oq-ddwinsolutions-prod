...
#[ORM\Entity(repositoryClass: QqoqccpAnalysisRepository::class)]
#[ORM\Index(columns: ['user_id'], name: 'idx_qqoqccp_user')]
#[ORM\Index(columns: ['created_at'], name: 'idx_qqoqccp_created_at')]
class QqoqccpAnalysis
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
