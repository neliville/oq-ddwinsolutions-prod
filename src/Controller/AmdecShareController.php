...
use App\Entity\AmdecShareVisit;
...
final class AmdecShareController extends AbstractController
{
    ...
    #[Route('/amdec/partage/{token}', name: 'app_amdec_share_view')]
    public function view(string $token, AmdecShareRepository $shareRepository, Request $request): Response
    {
        ...
        if (!isset($content['subject'])) {
            $content['subject'] = $analysis->getSubject();
        }

        $visit = new AmdecShareVisit();
