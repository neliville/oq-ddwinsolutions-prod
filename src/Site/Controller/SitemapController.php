...
final class SitemapController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        $routesToAdd = [
            ...
            ['route' => 'app_ressources_index', 'priority' => '0.7', 'changefreq' => 'monthly'],
            // Pages éditoriales SEO par outil
            ['route' => 'app_tool_seo_ishikawa',  'priority' => '0.75', 'changefreq' => 'monthly'],
            ['route' => 'app_tool_seo_5pourquoi',  'priority' => '0.75', 'changefreq' => 'monthly'],
            ['route' => 'app_tool_seo_qqoqccp',    'priority' => '0.75', 'changefreq' => 'monthly'],
            ['route' => 'app_tool_seo_amdec',      'priority' => '0.75', 'changefreq' => 'monthly'],
            ['route' => 'app_tool_seo_pareto',     'priority' => '0.75', 'changefreq' => 'monthly'],
            ['route' => 'app_tool_seo_8d',         'priority' => '0.75', 'changefreq' => 'monthly'],
