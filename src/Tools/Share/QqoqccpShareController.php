...
use App\Entity\QqoqccpShareVisit;
...
final class QqoqccpShareController extends AbstractController
{
    ...
    #[Route('/qqoqccp/partage/{token}', name: 'app_qqoqccp_share_view')]
    public function view(string $token, QqoqccpShareRepository $shareRepository, Request $request): Response
    {
        ...
        return $this->render('share/share_placeholder.html.twig', [
            ...
            'tool' => [
                'slug' => 'qqoqccp',
                'name' => 'Analyse QQOQCCP',
                'originRoute' => 'app_qqoqccp_index',
            ],
