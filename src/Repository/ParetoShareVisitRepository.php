...
/**
 * @extends ServiceEntityRepository<ParetoShareVisit>
 */
class ParetoShareVisitRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, ParetoShareVisit::class);
    }
    ...
    private function getTableName(Connection $connection): string
    {
        return $connection->quoteIdentifier(
            $this->getEntityManager()->getClassMetadata(ParetoShareVisit::class)->getTableName()
        );
    }
}
