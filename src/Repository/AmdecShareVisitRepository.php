...
/**
 * @extends ServiceEntityRepository<AmdecShareVisit>
 */
class AmdecShareVisitRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, AmdecShareVisit::class);
    }
    ...
    private function getTableName(Connection $connection): string
    {
        return $connection->quoteIdentifier(
            $this->getEntityManager()->getClassMetadata(AmdecShareVisit::class)->getTableName()
        );
    }
}
