...
/**
 * @extends ServiceEntityRepository<QqoqccpShareVisit>
 */
class QqoqccpShareVisitRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, QqoqccpShareVisit::class);
    }
    ...
    private function getTableName(Connection $connection): string
    {
        return $connection->quoteIdentifier(
            $this->getEntityManager()->getClassMetadata(QqoqccpShareVisit::class)->getTableName()
        );
    }
}
