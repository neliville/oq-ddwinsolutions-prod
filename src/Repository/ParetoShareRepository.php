...
/**
 * @extends ServiceEntityRepository<ParetoShare>
 */
class ParetoShareRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, ParetoShare::class);
    }

    public function findValidByToken(string $token): ?ParetoShare
    {
