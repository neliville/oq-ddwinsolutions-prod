...
/**
 * @extends ServiceEntityRepository<EightDShareVisit>
 */
class EightDShareVisitRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, EightDShareVisit::class);
    }
    ...
    private function getTableName(Connection $connection): string
    {
        return $connection->quoteIdentifier(
            $this->getEntityManager()->getClassMetadata(EightDShareVisit::class)->getTableName()
        );
    }
}
