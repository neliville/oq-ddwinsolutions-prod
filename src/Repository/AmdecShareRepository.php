...
/**
 * @extends ServiceEntityRepository<AmdecShare>
 */
class AmdecShareRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, AmdecShare::class);
    }

    public function findValidByToken(string $token): ?AmdecShare
    {
