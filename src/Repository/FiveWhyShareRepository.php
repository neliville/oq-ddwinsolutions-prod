...
/**
 * @extends ServiceEntityRepository<FiveWhyShare>
 */
class FiveWhyShareRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, FiveWhyShare::class);
    }

    public function findValidByToken(string $token): ?FiveWhyShare
    {
